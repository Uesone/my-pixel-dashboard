...
// === BUCO POWER HUB FISSO, VALORI BASE ===
const HOLE_TOP = 268;    // Y pixel (es: lampadina)
const HOLE_LEFT = 540;   // X pixel
const HOLE_WIDTH = 40;
const HOLE_HEIGHT = 93;

/**
 * DashboardBase: pixel-perfect layout, ghost div fisso per CLS = 0!
 */
const DashboardBase = forwardRef(({
  scale = 1.5,                // Match con App.jsx!
  children,
  showPageRoll = false,
  ...
  >
    ...
    {/* === FRAME === */}
    <img src={frame} alt="frame" width={DASHBOARD_WIDTH} height={DASHBOARD_HEIGHT}
      style={{
    ...
    <img src={leftBar} alt="left bar" width={129} height={373}
      style={{
        position: "absolute", top: 13, left: 36, zIndex: 2, pointerEvents: "none",
        imageRendering: "pixelated", display: "block"
      }}
      draggable={false} loading="eager"
    />
    {/* === SFONDO === */}
    <img src={background} alt="background" width={370} height={380}
      style={{
        position: "absolute", top: 5, left: 103, zIndex: 3, pointerEvents: "none",
        imageRendering: "pixelated", display: "block"
      }}
      draggable={false} loading="eager"
    />
    {/* === AREA CONTENUTO === */}
    <div style={{
      position: "absolute", top: 52, left: 130, width: 310, height: 290,
    ...
    {/* === ANGOLI === */}
    {!isFlipping && (
      <img src={corners} alt="corners" width={343} height={385}
        style={{
          position: "absolute", top: 3, left: 116, zIndex: 20, pointerEvents: "none",
          imageRendering: "pixelated", display: "block"
        }}
        draggable={false} loading="eager"
      />
    ...
    {/* === POWER HUB === */}
    <img src={powerHubTube} alt="power hub tube" width={438} height={325}
      style={{
        position: "absolute", top: 23, left: 25, zIndex: 30, pointerEvents: "none",
        imageRendering: "pixelated", display: "block"
      }}
      draggable={false} loading="eager"
    />
    {/* === GLOW EFFECTS === */}
    {[
      { top: 50, left: 35 }, { top: 150, left: 35 }, { top: 65, left: 428 },
      { top: 170, left: 428 }, { top: 250, left: 35 }, { top: 36, left: 400, vertical: true },
      { top: 36, left: 320, vertical: true }, { top: 36, left: 245, vertical: true },
      { top: 36, left: 160, vertical: true }, { top: 36, left: 80, vertical: true }
    ].map((glow, i) => (
      <img
        key={i}
        src={powerHubGlow}
    ...
    {/* === POWER HUB BOX === */}
    <img src={powerHubBox} alt="power hub box" width={77} height={123}
      style={{
        position: "absolute", top: 230, left: 418, zIndex: 33, pointerEvents: "none",
        imageRendering: "pixelated", display: "block"
      }}
      draggable={false} loading="eager"
    />
